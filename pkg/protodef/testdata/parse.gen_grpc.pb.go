...
const (
	TestService_TestMethod_FullMethodName = "/groxy.runtime_generated.TestService/TestMethod"
)
...
func (c *testServiceClient) TestMethod(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedTestServiceServer) TestMethod(context.Context, *Request) (*Response, error) {
...
func _TestService_TestMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServiceServer).TestMethod(ctx, req.(*Request))
	}
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "groxy.runtime_generated.TestService",
